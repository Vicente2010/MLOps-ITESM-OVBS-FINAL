...
# This module will not use the logging utility since is a level bellow to use it
import logging
...
def predict_online_fraud(input):
    url3 = "http://app.docker:8000/predict_fraud_dt"
...
def classify(payload: dict = Body(...)):
    ...
    response = predict_online_fraud(payload)
